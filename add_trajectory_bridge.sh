...
ulimit -n 20000
python3 modify_rlds_dataset.py --dataset=bridge --data_dir=/shared/karl/data/bridge_orig/1.0.0/ --target_dir=$CONVERSION_DIR --mods=visual_trajectory --n_workers=$N_WORKERS --max_episodes_in_memory=$MAX_EPISODES_IN_MEMORY
